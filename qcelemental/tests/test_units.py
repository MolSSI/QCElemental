...
def test_unit_conversion_nist_2014(from_unit, to_unit, expected):
    # Build values and quantize to the tolerance
    constants = qcelemental.PhysicalConstantsContext("CODATA2014")
    expected = Decimal(expected)
    from_to_value = Decimal(constants.conversion_factor(from_unit, to_unit)).quantize(expected)
...
def test_unit_conversion_nist_2018(from_unit, to_unit, expected):
    # Build values and quantize to the tolerance
...
def test_unit_conversion_other_2014(from_unit, to_unit, expected):
    # Build values and quantize to the tolerance
    constants = qcelemental.PhysicalConstantsContext("CODATA2014")
    expected = Decimal(expected)
    from_to_value = Decimal(constants.conversion_factor(from_unit, to_unit)).quantize(expected)
    ...
    to_from_value = Decimal(constants.conversion_factor(to_unit, from_unit))
...
def test_unit_conversion_other_2018(from_unit, to_unit, expected):
    # Build values and quantize to the tolerance
    constants = qcelemental.PhysicalConstantsContext("CODATA2018")
    expected = Decimal(expected)
    from_to_value = Decimal(constants.conversion_factor(from_unit, to_unit)).quantize(expected)
